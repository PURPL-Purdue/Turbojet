function plot_blade_V3(blade, plot_throat, plot_t_max, plot_bez_p1)
    for i = 1:length(blade)
        ...
        if plot_throat
            line(blade.x_o, blade.y_o, [blade.R, blade.R], Color='blue', LineStyle='--')            % Throat!!!
        end
        if plot_t_max
            line(blade.x_thicc, blade.y_thicc, [blade.R, blade.R], Color='green', LineStyle='--')   % T-Max!!!!
        end
        if plot_bez_p1
            line([blade.x(3), blade.ss_p1x], [blade.y(3), blade.ss_p1y], [blade.R, blade.R], Color='red', LineStyle='--')
            line([blade.ss_p1x, blade.x(2)], [blade.ss_p1y, blade.y(2)], [blade.R, blade.R], Color='red', LineStyle='--')
            line([blade.x(4), blade.ps_p1x], [blade.y(4), blade.ps_p1y], [blade.R, blade.R], Color='red', LineStyle='--')
            line([blade.ps_p1x, blade.x(5)], [blade.ps_p1y, blade.y(5)], [blade.R, blade.R], Color='red', LineStyle='--')
            plot3(blade.ss_p1x, blade.ss_p1y, blade.R, '.b', MarkerSize=5)
            plot3(blade.ps_p1x, blade.ps_p1y, blade.R, '.b', MarkerSize=5)
        end
