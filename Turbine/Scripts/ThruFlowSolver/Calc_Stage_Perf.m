function output = Calc_Stage_Perf(deg_of_reaction, blade_height_mm, ...
    ...
    r_tip = 0.05; %meters
    r_hub = r_tip-blade_height; %meters
    r_mid = (r_hub+r_tip)./2;
    ...
    % thru_flow_sol = lossless_thru_flow; 
    thru_flow_sol = MidSpan_ThruFlow(deg_of_reaction, blade_height_mm, r_tip.*1000, ...
        ...
        stator_enthalphy_loss, rotor_enthalphy_loss, true);
    ...
    output.rotor_thk2chord = rotor_thk2chord;
    output.stator_thk2chord = stator_thk2chord;
